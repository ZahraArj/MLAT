...
function visualize_traj_est(IDX_data_packet, ...
                            stt_var_runtime, ...
...
if size(Traj_origin_GT, 1) >= 1
    ...
    plot3(x_traj, y_traj, z_traj, 'o', 'MarkerSize', 1, 'Color', [0.0, 0.8, 0.0]);  
...
if isempty(traj_EST_graph) == 0
    ...
    plot3(x_traj, y_traj, z_traj, 'o', 'MarkerSize', 2, 'Color', [0.0, 0.0, 1.0]);
