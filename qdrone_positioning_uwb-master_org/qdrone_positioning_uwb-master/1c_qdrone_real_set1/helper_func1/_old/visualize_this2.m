...
function visualize_this2(IDX_data_packet, Time_now, Traj_origin_GT, Traj_origin_EST, Mat_body_rot_GT, Mat_body_trans_GT, Set_pos_station_uwb, Set_pos_station_uwb_ground)

% visualize_this 에 비해 다른점:
%   traj을 line으로 표현
...
if size(Traj_origin_GT, 1) >= 1,
    ...
    plot3(x_traj, y_traj, z_traj, 'r-', 'LineWidth', 0.5);
...
if size(Traj_origin_EST, 1) >= 1,
    ...
    plot3(x_traj, y_traj, z_traj, 'b-', 'LineWidth', 0.5);
