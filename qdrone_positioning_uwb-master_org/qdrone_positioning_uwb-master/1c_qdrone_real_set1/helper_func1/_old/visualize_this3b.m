...
function visualize_this3b(IDX_data_packet, Time_now, ...
                          Traj_origin_GT, Mat_body_rot_GT, Mat_body_trans_GT, ...
                          Traj_origin_EST, Mat_body_rot_EST, Mat_body_trans_EST, ...
...
if size(Traj_origin_GT, 1) >= 1,
    ...
    plot3(x_traj, y_traj, z_traj, 'o', 'MarkerSize', 1.2, 'Color', [0.0, 0.85, 0.0], 'MarkerFaceColor', [0.0, 0.85, 0.0]);
...
if size(Traj_origin_EST, 1) >= 1,
    ...
    plot3(x_traj, y_traj, z_traj, 'o', 'MarkerSize', 1.2, 'Color', 'b', 'MarkerFaceColor', 'b');
