...
function [avg_err_xyz_out, ...
          ...
          avg_err_x_out, ...
          avg_err_y_out, ...
          avg_err_z_out] = compute_accuracy_ae_traj_estimated(Traj_GT, Traj_EST)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Traj_GT : xyz, (n x 4), 4:time,x,y,z
% Traj_EST: xyz, (n x 3), 3:x,y,z
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for i = 1:totnum_steps,
    dx = Traj_GT(i,2) - Traj_EST(i,1);
    dy = Traj_GT(i,3) - Traj_EST(i,2);
    dz = Traj_GT(i,4) - Traj_EST(i,3);
