...
function [Data_sensor_imu_out] = correct_data_sensor_imu(Data_sensor_imu_in)
...
Data_sensor_imu_out(2) =  1.0*Data_sensor_imu_in(2);
Data_sensor_imu_out(3) =  1.0*Data_sensor_imu_in(3);
