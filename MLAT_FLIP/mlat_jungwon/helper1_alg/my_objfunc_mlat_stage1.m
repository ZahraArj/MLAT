...
function set_err = my_objfunc_mlat_stage1(params)
...
e_z    = 0.1*(z_drone - g_mlat_z_height);

set_err = [e_uwb1; e_uwb2; e_uwb3; e_uwb4; e_z; 9];
% set_err = [e_uwb1; e_uwb2; e_uwb3; e_uwb4];
